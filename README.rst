...
.. image:: https://github.com/catalyst-cooperative/handbook/workflows/tox-pytest/badge.svg
   :target: https://github.com/catalyst-cooperative/handbook/actions?query=workflow%3Atox-pytest
   :alt: Tox-PyTest Status

.. image:: https://github.com/catalyst-cooperative/handbook/workflows/repo2docker/badge.svg
   :target: https://github.com/catalyst-cooperative/handbook/actions?query=workflow%3Arepo2docker
   :alt: repo2docker Build Status

.. image:: https://github.com/catalyst-cooperative/handbook/workflows/docker-build-push/badge.svg
   :target: https://github.com/catalyst-cooperative/handbook/actions?query=workflow%3Adocker-build-push
   :alt: Docker build status

.. image:: https://img.shields.io/codecov/c/github/catalyst-cooperative/handbook?style=flat&logo=codecov
   :target: https://codecov.io/gh/catalyst-cooperative/handbook
   :alt: Codecov Test Coverage

.. image:: https://img.shields.io/readthedocs/catalystcoop-handbook?style=flat&logo=readthedocs
   :target: https://catalystcoop-handbook.readthedocs.io/en/latest/
   :alt: Read the Docs Build Status

.. image:: https://img.shields.io/pypi/v/catalystcoop.handbook?style=flat&logo=python
   :target: https://pypi.org/project/catalystcoop.handbook/
   :alt: PyPI Latest Version

.. image:: https://img.shields.io/conda/vn/conda-forge/catalystcoop.handbook?style=flat&logo=condaforge
   :target: https://anaconda.org/conda-forge/catalystcoop.handbook
   :alt: conda-forge Version

.. image:: https://img.shields.io/pypi/pyversions/catalystcoop.handbook?style=flat&logo=python
   :target: https://pypi.org/project/catalystcoop.handbook/
...
``handbook`` (the cat who isn't entirely there...).
...
* The name of the repository should be the same as the name of the new Python package
  you are going to create. E.g. a repository at ``catalyst-cooperative/handbook``
  should be used to define a package named ``handbook``.
...
* Create the ``handbook`` conda environment by running ``conda env create`` or
  (preferably) ``mamba env create`` in the top level of the repository.
* Activate the new conda environment with ``conda activate handbook``.
...
Once you know that your forked version of the ``handbook`` package is working as
...
Python Package Index (PyPI) or on ``conda-forge``. Similarly the ``handbook``
package becomes the ``catalystcoop.handbook`` distribution. The distribution
name is determined by the ``name`` argument in the call to ``setup()`` in ``setup.py``.

.. code:: bash

  pip install catalystcoop.handbook
...
word ``handbook`` at the command line, or use the search-and-replace
...
* Rename the ``src/handbook`` directory to reflect the new package name.
* Search for ``handbook`` and replace it as appropriate everywhere. Sometimes
  this will be with a distribution name like ``catalystcoop.handbook``
...
* When the tests are run via the ``tox-pytest`` workflow in GitHub Actions, the test
  ...
  the results
  `for the handbook repo <https://app.codecov.io/gh/catalyst-cooperative/handbook>`__.
...
* It will ask you for a project name -- this will become part of the domain name for the
  ...
  dots and underscores replaced with dashes. E.g. ``catalystcoop-handbook`` or
